...
public class UpdateBookingResponse {
    ...
    // Asserts for XML tests
    public void assertUpdateBookingFirstnameWithBasicAuthXML(ValidatableResponse response, NewBooking currentBooking) {
        response
                .assertThat()
                .statusCode(HttpURLConnection.HTTP_OK)
                .body("firstname", equalTo("Karla"))
    ...
    public void assertUpdateBookingFirstnameWithCookieAuthXML(ValidatableResponse response, NewBooking currentBooking) {
        response
                .assertThat()
                .statusCode(HttpURLConnection.HTTP_OK)
                .body("firstname", equalTo("Karla"))
    ...
    public void assertUpdateBookingWithoutBasicAuthAndCookieXML(ValidatableResponse response, NewBooking currentBooking) {
        response
                .assertThat()
                .statusCode(HttpURLConnection.HTTP_FORBIDDEN);
    }
