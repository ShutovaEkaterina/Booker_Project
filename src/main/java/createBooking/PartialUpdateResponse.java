...
public class PartialUpdateResponse {
    ...
    // Asserts for XML authorization
    public void assertPartialUpdateBookingFirstnameWithBasicAuthXML(ValidatableResponse response, NewBooking currentBooking) {
        response
                .assertThat()
                .statusCode(HttpURLConnection.HTTP_OK)
                .body("firstname", equalTo("Karla"))
    ...
    public void assertPartialUpdateBookingFirstnameWithCookieAuthXML(ValidatableResponse response, NewBooking currentBooking) {
        response
                .assertThat()
                .statusCode(HttpURLConnection.HTTP_OK)
                .body("firstname", equalTo("Karla"))
