...
public class UpdateBookingWithoutAuthHeaderXMLTest {
    ...
    @Test
    public void updateBookingWithoutBasicAuthAndCookieTestXML() {
        String xmlBody = "<booking>\n" +
                ...
                "</booking>";
        ValidatableResponse response = updateBookingRequest.updateBookingWithoutBasicAuthAndCookieXML(id, xmlBody);
        updateBookingResponse.assertUpdateBookingWithoutBasicAuthAndCookieXML(response, currentBooking);
    }
}
